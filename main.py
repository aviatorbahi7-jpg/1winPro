...
# Firebase Initialize
# আপনার JSON ফাইলের নামটি এখানে হুবহু দিবেন
cred = credentials.Certificate("telegram-60f96-firebase-adminsdk-fbsvc-b5ccfb343c.json")
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://telegram-60f96-default-rtdb.firebaseio.com/' 
})

# Firebase User Status Function
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    save_user(user_id)
    update_user_status(user_id, "online") # Firebase Update
...
# (Broadcast functions remain same as yours)
